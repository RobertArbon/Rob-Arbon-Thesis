...
%     \centering
%     \begin{tabular}{c|c}
%       System   &  Parameterization ($D_w(a_w)$ (\si{\meter\squared\per\second}))\\
%       Aqueous-Levoglucosan   & $\log \left(\mathrm{D}_{\mathrm{w}}\left(\mathrm{a}_{\mathrm{w}}\right)\right)=-14.091+\left(2.192 \times \mathrm{a}_{\mathrm{w}}\right)+\left(-21.269 \times\left(\mathrm{a}_{\mathrm{w}}\right)^{2}\right)+\left(81.025 \times\left(\mathrm{a}_{\mathrm{w}}\right)^{3}\right)+(-84.660 \times$
% $\left.\left(\mathrm{a}_{\mathrm{w}}\right)^{4}\right)+\left(28.081 \times\left(\mathrm{a}_{\mathrm{w}}\right)^{5}\right)$ \\
%     \end{tabular}
%     \caption{Caption}
%     \label{tab:my_label}
% \end{table}
