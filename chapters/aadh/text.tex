...
Aromatic amine dehydrogenase (AADH) oxidizes primary aromatic amines to the corresponding aldehyde and ammonia \cite{masgrauAtomicDescriptionEnzyme2006}: 

 Amines are natural by-products of human activity and their degradation is an is an important part of the natural cycle which maintains their balance within organisms and the environment \cite{chistoserdovCloningSequencingMutagenesis2001}. 

After isolation and structural characterisation with X-ray crystallography, previous work on AADH has focused on determining the reaction mechanism and explaining the inflated kinetic isotope effect which was discussed briefly in the introduction to this thesis. This introduction will discuss the experimental and computational work done to characterise the reaction mechanism, explain in detail the kinetic isotope effect and its link to quantum mechanical tunneling and protein dynamics, and finally link this Markov models and the aims of this chapter. 
...
\subsection{Tunneling and the kinetic isotope effect}
...
A simplified version of the full tunneling rate expression \cite{knappTemperatureDependentIsotopeEffects2002, kohenRoleDynamicsEnzyme2015} is: 
...
\subsection{Tunneling and protein dynamics}
